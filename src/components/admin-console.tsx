  ...
  return (
    <main className="admin-shell">
      ...
      <div className="admin-main">
        ...
        {demo ? <div className="admin-demo-banner"><CircleAlert size={16} /><span><strong>Simulation mode:</strong> user, group, and settings changes work in this preview but are not durable until the Supabase database is connected.</span></div> : null}
